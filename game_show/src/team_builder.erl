...
random_list_test_() ->
	Random_numbers = [rand:uniform(10) || _ <-lists:seq(1,10)],%replace this with the list of 10 random integers 
...
person_tuple_list_test_() ->
	People = [{sue,female, 1.6}, {mausham, male, 1.7}, {sangita, female, 1.2}, {madhu, male, 1.3}, {sajan, male, 1.3}, {bishwas, male, 1.3}, {binjana, female, 1.5}, {avi, male, 1.3}],%replace this with the list of tuples described in the previous comment
